-- Publication contract v1 / schema v1
-- Psychotherapy collection candidate tables for Phase 1A spike.
...
CREATE TABLE IF NOT EXISTS entries (
  ...
  author TEXT,
  published_date TEXT,
  credibility_tier INTEGER NOT NULL DEFAULT 2,
...
CREATE INDEX IF NOT EXISTS idx_entries_modality ON entries(therapy_modality);
...
-- Isolated searchable text. Abstracts live only here when the feature gate is on.
-- Serializers must never SELECT abstract_text for public responses.
