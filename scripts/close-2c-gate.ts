...
function main() {
  console.log("Closing Phase 2C gate…");
  ...
  const decision = `# Phase 2C Decision Record
...
`;
  ...
  writeFileSync(resolve("docs/phase-2c-decision-record.md"), decision);
  console.log("Wrote docs/phase-2c-decision-record.md");
  console.log("Phase 2C gate closed.");
}
