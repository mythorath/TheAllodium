...
function main() {
  console.log("Closing Phase 2.5B gate…");
  ...
  const decision = `# Phase 2.5B Decision Record
...
`;
  ...
  writeFileSync(resolve("docs/phase-2.5b-decision-record.md"), decision);
  console.log("Wrote docs/phase-2.5b-decision-record.md");
  console.log("Phase 2.5B gate closed.");
}
