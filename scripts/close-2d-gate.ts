...
function main() {
  console.log("Closing Phase 2D gate…");
  ...
  const decision = `# Phase 2D Decision Record
...
`;
  ...
  writeFileSync(resolve("docs/phase-2d-decision-record.md"), decision);
  console.log("Wrote docs/phase-2d-decision-record.md");
  console.log("Phase 2D gate closed.");
}
