...
function main() {
  console.log("Closing Phase 3B gate…");
  ...
  const decision = `# Phase 3B Decision Record
...
`;
  ...
  writeFileSync(resolve("docs/phase-3b-decision-record.md"), decision);
  console.log("Wrote docs/phase-3b-decision-record.md");
  console.log("Phase 3B gate closed.");
}
